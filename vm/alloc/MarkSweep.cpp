 ...
 */
static inline bool isMarked(const Object *obj, const GcMarkContext *ctx)
{
 ...
 */
static inline void markStackPush(GcMarkStack *stack, const Object *obj)
{
    assert(stack != NULL);
...
static inline long setAndReturnMarkBit(GcMarkContext *ctx, const void *obj)
{
...
static inline void markObjecttrue(const Object *obj, GcMarkContext *ctx)
{
    assert(ctx != NULL);
    assert(obj != NULL);
    assert(dvmIsValidObject(obj));
...
static inline void markObjectfalse(const Object *obj, GcMarkContext *ctx)
{
    assert(ctx != NULL);
    assert(obj != NULL);
    assert(dvmIsValidObject(obj));
 ...
 */
static inline void markObject(const Object *obj, GcMarkContext *ctx)
{
    if (obj != NULL) {
        markObjecttrue(obj, ctx);
    }
}
 ...
 */
static inline void scanObject(const Object *obj, GcMarkContext *ctx)
{
    assert(obj != NULL);
    assert(obj->clazz != NULL);
