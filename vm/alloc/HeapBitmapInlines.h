...
static inline unsigned long _heapBitmapModifyObjectBitTT(HeapBitmap *hb, const void *obj)
{
    const uintptr_t offset = (uintptr_t)obj - hb->base;
    const size_t index = HB_OFFSET_TO_INDEX(offset);
    const unsigned long mask = HB_OFFSET_TO_MASK(offset);
...
static inline void _heapBitmapModifyObjectBitTF(HeapBitmap *hb, const void *obj)
{
    const uintptr_t offset = (uintptr_t)obj - hb->base;
    const size_t index = HB_OFFSET_TO_INDEX(offset);
    const unsigned long mask = HB_OFFSET_TO_MASK(offset);
...
static inline void  _heapBitmapModifyObjectBitFF(HeapBitmap *hb, const void *obj)
{
    const uintptr_t offset = (uintptr_t)obj - hb->base;
    const size_t index = HB_OFFSET_TO_INDEX(offset);
    const unsigned long mask = HB_OFFSET_TO_MASK(offset);
...
//                                                        const void *obj)
static inline unsigned long dvmHeapBitmapSetAndReturnObjectBit(HeapBitmap *hb,
                                                        const void *obj)
{
    //return _heapBitmapModifyObjectBit(hb, obj, true, true);
    return _heapBitmapModifyObjectBitTT(hb, obj);
}
...
static void dvmHeapBitmapSetObjectBit(HeapBitmap *hb, const void *obj)
{
    ...
    _heapBitmapModifyObjectBitTF(hb, obj);
}
...
static void dvmHeapBitmapClearObjectBit(HeapBitmap *hb, const void *obj)
{
    ...
    _heapBitmapModifyObjectBitFF(hb, obj);
}
